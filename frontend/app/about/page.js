...
export default function AboutPage() {
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', paddingTop: 40 }}>
      ...
      <p style={{ fontSize: 14, color: 'var(--color-text-secondary)', lineHeight: 1.7, marginBottom: 32 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32 }}>
        {[
          ...
          <div key={item.title} className="card" style={{ padding: 16, display: 'flex', gap: 14 }}>
            <div style={{ width: 36, height: 36, borderRadius: 8, background: 'var(--color-accent-muted)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
